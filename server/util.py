...
def classify_image(image_base64_data, file_path= None):
    ...
    for img in imgs:
        ...
        final = combined_img.reshape(1, len_image_array).astype(float) # for testing purpose just 1 image hence first argument of reshape is 1. We converted it to array as predict function expects an array of images
        result.append({
...
if __name__ == "__main__":
    ...
    print(classify_image(None, 'test_images/roger2.jpg'))
